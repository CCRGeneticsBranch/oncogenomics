...
class CookieJar {
	 ...
	 */
	public function make($name, $value, $minutes = 0, $path = null, $domain = null, $secure = true, $httpOnly = true)
	{
	 ...
	 * @return \Symfony\Component\HttpFoundation\Cookie
	 */
	public function forever($name, $value, $path = null, $domain = null, $secure = true, $httpOnly = true)
	{
