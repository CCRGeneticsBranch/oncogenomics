...
Route::get('/setProjectByToken/{user}/{token}',[
         "before" => "csrf",
        "uses"   => 'ProjectController@setProjectByToken']);//hvr
Route::get('/getProjectByUser/{user}','ProjectController@getProjectByUser');//hvr
Route::get('/admin/login', "Jacopo\\Authentication\\Controllers\\AuthController@getClientLogin");
...
Route::post('/postTokenLogin', [
        "before" => "csrf",
        "uses"   => "Jacopo\\Authentication\\Controllers\\AuthController@postTokenLogin"
]);
Route::post('/user/notifyAdmin', [
        "before" => "csrf",
        "uses"   => "Jacopo\\Authentication\\Controllers\\AuthController@notifyAdmin"
]);
Route::post('/login', [
        "before" => "csrf",
        "uses"   => "Jacopo\\Authentication\\Controllers\\AuthController@postClientLogin"
]);
Route::get('/viewContacts', "Jacopo\\Authentication\\Controllers\\AuthController@getContacts");
/**
 * Password recovery
 */
