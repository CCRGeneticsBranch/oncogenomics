...
{{ HTML::script('packages/DataTables-1.10.8/media/css/dataTables.bootstrap.css') }}
...
table.dataTable thead .sorting { background: url('/packages/DataTables-1.10.8/media/images/sort_both.png') no-repeat center right; }
</style>
