...
Route::get ('getRNAseqSample/{sample_id}', 'SampleController@getRNAseqSample');
...
Route::group(['before' => ['authorized_patient']], function () {
	...
	Route::get('/getQC/{patient_id}/{case_id}/{type}/{project_id?}', 'VarController@getQC' );
	...
	Route::get('/getAntigenData/{project_id}/{patient_id}/{case_id}/{sample_id}/{high_conf_only?}/{format?}'            , 'VarController@getAntigenData'  );
	...
	Route::get('/getHotspotCoverage/{patient_id}/{case_id}/{project_id?}', 'VarQCController@getHotspotCoverage' );
...
Route::group(['before' => ['logged', 'can_see']], function () {
	...
	Route::get ('/viewTIL/{project_id}'             , 'ProjectController@viewTIL');
	Route::get ('/getTIL/{project_id}'             , 'ProjectController@getTIL');
	...
	Route::get('/viewChIPseq/{patient_id}/{case_id}', 'SampleController@viewChIPseq');
	Route::get('/viewChIPseqIGV/{patient_id}/{case_id}', 'SampleController@viewChIPseqIGV');
	Route::get('/viewChIPseqMotif/{patient_id}/{case_id}/{sample_id}/{cutoff}/{type}', 'SampleController@viewChIPseqMotif');	
	...
	Route::post('/broadcast', 'BaseController@broadcast');	
	...
	Route::get('/getPatientGenotyping/{patient_id}/{case_id}/{project_id?}'                       , 'SampleController@getPatientGenotyping');
	Route::get ('/getTranscriptExpressionData/{gene_list}/{sample_id}', 'GeneDetailController@getTranscriptExpressionData');
	
	
	Route::get('/getCNVByGene/{project_id}/{gene_id}/{source?}/{format?}'            , 'VarController@getCNVByGene'  );
	...
	Route::get('/getBigWig/{path}/{patient_id}/{case_id}/{sample_id}/{file}', 'VarController@getBigWig');
	...
	Route::get('/getSignaturePlot/{patient_id}/{sample_name}/{case_id}/{file?}', 'VarController@getSignaturePlot');
	Route::get('/getTCellExTRECTPlot/{patient_id}/{case_id}/{sample_id}', 'VarController@getTCellExTRECTPlot');	
	...
	Route::get('/viewCNV/{project_id}/{patient_id}/{case_id}/{sample_name}/{source}/{gene_centric?}', 'VarController@viewCNV' );
	...
	Route::get('/viewSearchSample/{keyword}'                       , 'SampleController@viewSearchSample');
	Route::get('/searchSample/{keyword}'                       , 'SampleController@searchSample');
...
Route::get ('/getCaseBySampleID/{sample_id}', 'SampleController@getCaseBySampleID');
...
Route::get ('/getPatientsJsonByCaseName/{case_name}', 'SampleController@getPatientsJsonByCaseName');
...
Route::post('/downloadFusion', 'VarController@downloadFusion');
...
Route::post('/getAntigenData', 'VarController@getAntigenDataByPost');

Route::post('/downloadVariants', 'VarController@downloadVariants');
Route::post('/downloadCNV', 'VarController@downloadCNV');
