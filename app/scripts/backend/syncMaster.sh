...
data_home=${html_home}/clinomics/app/storage/data
...
if [ $khanlab_modified = "1" ] || [ $clinomics_modified = "1" ] || [ $other_modified = "1" ] || [ $compass_modified = "1" ] || [ $compass_lims_modified = "1" ]
then
	echo -e $msg
	echo '------------------'
	echo `date`
	scp $clinomics_master_file $khanlab_master_file $other_master_file $compass_master_file $compass_lims_master_file helix:/data/Clinomics/MasterFiles/
	echo "Uploading production database..."
	echo "$script_home_production/syncMaster.pl -u -n production -i $clinomics_master_file,$khanlab_master_file,$other_master_file,$compass_master_file,$compass_lims_master_file,$tcga_master_file,$gtex_master_file -m $clinomics_modified,$khanlab_modified,$other_modified,0,0 "
	perl $script_home_production/syncMaster.pl -u -n production -i $clinomics_master_file,$khanlab_master_file,$other_master_file,$compass_master_file,$compass_lims_master_file,$tcga_master_file,$gtex_master_file -m $clinomics_modified,$khanlab_modified,$other_modified,$compass_modified,$compass_lims_modified,0,0	
	...
	perl $script_home_dev/syncMaster.pl -u -i $clinomics_master_file,$khanlab_master_file,$other_master_file,$compass_master_file,$compass_lims_master_file,$tcga_master_file,$gtex_master_file -m $clinomics_modified,$khanlab_modified,$other_modified,$compass_modified,$compass_lims_modified,0,0
